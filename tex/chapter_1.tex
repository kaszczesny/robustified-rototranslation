...
\begin{figure}[ht]
	...
	\caption{Example \cite{szczesny} of a distortion modeled with Conrady-Brown model. Vectors connect distorted pixel positions with their undistorted counterparts and contours mark areas with constant vector length. Tangential (non-radial) component is noticeable }
	\label{fig:brown}
\end{figure}
...
todo: demonstration of unboundedness
