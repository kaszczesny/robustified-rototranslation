...
\begin{figure}[hp]
	...
	\end{subfigure}
	\caption{\label{fig:teddyflip} An example of bad depth initialization (the warmer the color, the greater the depth) \protect\subref{fig:teddyfirst} Well-initialized depth, protect\subref{fig:teddybefore} Depth before the reinitialization, protect\subref{fig:teddyafter} Depth after the reinitialization,
