...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{\label{fig:teddyflip} An example of bad depth initialization (the warmer, the more distanced from the camera object is) \protect\subref{fig:teddyfirst} Well-initialized depth, protect\subref{fig:teddybefore} Depth before the reinitialization, protect\subref{fig:teddyafter} Depth after the reinitialization,
