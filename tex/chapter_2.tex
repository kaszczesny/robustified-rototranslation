...
Some thought was given to more elaborate initialization schemes. For example, todo cite uses feature points during initialization in order to quicker determine scene geometry. Feature point descriptors, such as SIFT \cite{sift}, are suited 
