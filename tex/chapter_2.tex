...
\begin{figure}[hp]
	...
	\caption{\label{fig:outliers} Outlier rejection example on the TUM \cite{tum} dataset. Keyline color on \protect\subref{fig:outlier_a}, \protect\subref{fig:outlier_b} and \protect\subref{fig:outlier_c} denotes Keyline history $k$ (the warmer, the greater)}
\end{figure}
