...
In \cite{arun1987least} it is described how to find an optimal (in the least square sense) translation and rotation between two trajectories 3D using SVD. Scaling factor can determined using \texttt{fminsearch}, a~black-box minimization routine available in the GNU Octave environment. Mean residual distance between optimized trajectories is the final accuracy measure that is used in Chapter~\ref{cha:results}.
