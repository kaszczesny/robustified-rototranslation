...
\begin{figure}[ht]
	...
	\caption{ Zero-crossing search. Local approximation of DoG values has been depicted with a colored plane. It intersects the $z=0$ plane, creating a red line. Blue line also lies on the $z=0$ plane; it passes through the origin (cyan point) and is perpendicular to red line. Intersection these two lines (black point) is the zero crossing }
	\label{fig:zeroc}
\end{figure}
