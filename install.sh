...
case $yn in
	[YyTt]* ) 
		...
		# latex
		sudo apt-get install -y texlive-base texlive-binaries texlive-science texlive-lang-polish texlive-lang-european texlive-bibtex-extra texlive-fonts-recommended latexdiff texstudio
